      ...
      <div className="space-y-1.5">
        ...
        <div
          className={`
            ...
            bg-[#F4F6F8] dark:bg-white/[0.06]
            transition-all duration-200
            ${passwordFocused ? 'bg-white dark:bg-white/[0.09] shadow-[0_2px_14px_rgba(15,23,42,0.08)]' : ''}
          `}
        >
          <Lock
            className={`w-4 h-4 shrink-0 mr-2.5 rtl:mr-0 rtl:ml-2.5 transition-colors duration-200 ${
              passwordFocused ? 'text-primary' : 'text-text-muted'
            }`}
          />
          <input
            id="password"
      ...
      <div className="flex items-center justify-between pt-0.5">
        <label className="flex items-center gap-2 cursor-pointer select-none">
          <button
            ...
            className={`
              relative w-4 h-4 rounded-[5px] flex items-center justify-center shrink-0
              border-2 transition-colors duration-150
              ${remember ? 'bg-primary border-primary' : 'border-border bg-transparent'}
            `}
          >
            <AnimatePresence>
              {remember && (
    ...
    />
      ...
      <div className="text-center text-sm text-text-secondary pt-1">
        ...
        <button
          ...
          className="text- hover:underline font-medium transition-colors"
        >
          {t('auth.signUp')}
        </button>
      </div>
